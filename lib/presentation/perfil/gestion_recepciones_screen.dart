...
class GestionRecepcionesScreen extends StatefulWidget {
  const GestionRecepcionesScreen({super.key});

  @override
  State<GestionRecepcionesScreen> createState() =>
      _GestionRecepcionesScreenState();
}

class _GestionRecepcionesScreenState extends State<GestionRecepcionesScreen> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              'Se restará esta cantidad del stock. Esta acción es irreversible.',
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Al borrar una recepción el stock se ajusta automáticamente.',
                              style: TextStyle(
                                color: Colors.red,
                                fontSize: 12,
